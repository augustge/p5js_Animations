...
function setup() {
  ...
  indexSlider = createSlider(0.1, 4.0, 1.33, 0.01)
  indexSlider.position(90,50);

  numRaySlider = createSlider(10, 5000, 5000, 10)
  ...
  opacitySlider = createSlider(1, 150, 20, 1)
  opacitySlider.position(90,130);

  reflectivitySlider = createSlider(0, 1, 0.2, 0.1)
  reflectivitySlider.position(90,150);

  radiusSlider = createSlider(10, 300, 100, 10)
  radiusSlider.position(90,170);

  radio = createRadio();
  radio.option("Droplet position",1);
  radio.option("Source Position",2);
  radio.style("color", "#FFFFFF");
  radio.position(90,190);

  drawIncomingCheckbox = createCheckbox("Draw incoming",false).style("color", "#FFFFFF")
  drawIncomingCheckbox.position(90,210);

  reducePowerCheckbox = createCheckbox("Reduce Power",true).style("color", "#FFFFFF")
  reducePowerCheckbox.position(90,230);
